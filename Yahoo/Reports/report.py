...
function filter_table(elem) {
    ...
    <h1>report.py</h1>
    <p>Report generated on 09-Sep-2019 at 13:22:41 by <a href="https://pypi.python.org/pypi/pytest-html">pytest-html</a> v1.20.0</p>
    <h2>Environment</h2>
    ...
    <h2>Summary</h2>
    <p>1 tests ran in 7.58 seconds. </p>
